...
<head>
    ...
    <title>Tambah Pegawai - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN pegawai-tambah.php YANG ANDA BERIKAN ========== */
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body-custom">
                ...
                <form action="{{ route('pegawai.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="no_pegawai" class="form-control-custom" placeholder="Masukkan no pegawai unik" value="{{ old('no_pegawai') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-user"></i> NAMA PEGAWAI</label>
                        <input type="text" name="nama_pegawai" class="form-control-custom" placeholder="Masukkan nama lengkap pegawai" value="{{ old('nama_pegawai') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-phone-alt"></i> TELEPON</label>
                        <input type="tel" name="tlp_pegawai" class="form-control-custom" placeholder="Masukkan nomor telepon pegawai" value="{{ old('tlp_pegawai') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-signature"></i> TANDA TANGAN</label>
                        <input type="file" name="ttd_pegawai" accept="image/png, image/jpeg, image/jpg" class="form-control-custom">
                        <small class="helper-text">
                            <i class="fas fa-info-circle"></i> Upload gambar tanda tangan (format PNG/JPG). Kosongkan jika belum ada.
                        </small>
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('pegawai.index') }}" class="btn btn-action btn-cancel">
