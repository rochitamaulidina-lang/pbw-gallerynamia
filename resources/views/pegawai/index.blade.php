...
<head>
    ...
    <title>Daftar Pegawai - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN YANG ANDA BERIKAN ========== */
        * {
            margin: 0;
            padding: 0;
    ...
    <nav id="sidebar">
        <div class="p-3 pt-3">
            ...
            <ul class="list-unstyled components mb-4">
                ...
                <li class="active"><a href="{{ route('pegawai.index') }}"><i class="fas fa-user-shield"></i> Pegawai</a></li>
    ...
    <div id="content" class="p-3 p-md-4">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="{{ route('pegawai.index') }}">Pegawai</a></li>
        ...
        <div class="card-table">
            <div class="card-header-custom">
                <h5><i class="fas fa-user-shield mr-2" style="color:#ff8c1a;"></i> Daftar Pegawai</h5>
                <a href="{{ route('pegawai.create') }}" class="btn btn-warning-custom">
            ...
            <div class="table-wrapper">
                <table class="data-table" id="data-table">
                    <thead>
                        <tr>
                            <th>
                                <a href="{{ route('pegawai.index', ['sort' => 'no_pegawai', 'order' => ($sortColumn == 'no_pegawai' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NO PEGAWAI
                                    <span class="sort-icon">
                                        @if($sortColumn == 'no_pegawai')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                            ...
                            <th>
                                <a href="{{ route('pegawai.index', ['sort' => 'nama_pegawai', 'order' => ($sortColumn == 'nama_pegawai' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NAMA PEGAWAI
                                    <span class="sort-icon">
                                        @if($sortColumn == 'nama_pegawai')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                            ...
                            <th>
                                <a href="{{ route('pegawai.index', ['sort' => 'tlp_pegawai', 'order' => ($sortColumn == 'tlp_pegawai' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    TELEPON
                                    <span class="sort-icon">
                                        @if($sortColumn == 'tlp_pegawai')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                            ...
                            <th>
                                <a href="{{ route('pegawai.index', ['sort' => 'ttd_pegawai', 'order' => ($sortColumn == 'ttd_pegawai' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    TANDA TANGAN
                                    <span class="sort-icon">
                                        @if($sortColumn == 'ttd_pegawai')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                    ...
                    <tbody id="table-body">
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                @if($p->ttd_pegawai)
                                    <span class="ttd-status ada"><i class="fas fa-check-circle"></i> Ada</span>
                                @else
                                    <span class="ttd-status tidak"><i class="fas fa-times-circle"></i> Tidak Ada</span>
                                @endif
                            </td>
                            <td style="white-space:nowrap;">
                                <a class="btn btn-sm-action btn-edit" href="{{ route('pegawai.edit', $p->no_pegawai) }}">
                                    <i class="fa-solid fa-pen-to-square"></i> Ubah
                                </a>
                                <button class="btn btn-sm-action btn-delete" onclick="showDeleteModal('{{ $p->no_pegawai }}')">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" style="text-align:center; padding:20px;">Tidak ada data pegawai</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="pagination">
                <div class="pagination-info">
                    Showing {{ $pegawai->firstItem() ?? 0 }} to {{ $pegawai->lastItem() ?? 0 }} of {{ $pegawai->total() }} entries
                </div>
                <div class="pagination-buttons">
                    @if ($pegawai->onFirstPage())
                        <span class="page-link disabled">Previous</span>
                    @else
                        <a class="page-link" href="{{ $pegawai->previousPageUrl() }}">Previous</a>
                    @endif
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5>Delete Pegawai</h5>
                <p>Are you sure you want to delete this pegawai?</p>
