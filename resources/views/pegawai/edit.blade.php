...
<head>
    ...
    <title>Ubah Pegawai - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN pegawai-ubah.php YANG ANDA BERIKAN ========== */
        * {
            margin: 0;
            padding: 0;
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            ...
            <div class="card-body-custom">
                ...
                <form action="{{ route('pegawai.update', $pegawai->no_pegawai) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="form-group-custom">
                        <label><i class="fas fa-id-card"></i> NO PEGAWAI</label>
                        <input type="text" name="no_pegawai" value="{{ $pegawai->no_pegawai }}" class="form-control-custom" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-user"></i> NAMA PEGAWAI</label>
                        <input type="text" name="nama_pegawai" value="{{ $pegawai->nama_pegawai }}" class="form-control-custom" placeholder="Masukkan nama lengkap pegawai" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-phone-alt"></i> TELEPON</label>
                        <input type="tel" name="tlp_pegawai" value="{{ $pegawai->tlp_pegawai }}" class="form-control-custom" placeholder="Masukkan nomor telepon pegawai" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-signature"></i> TANDA TANGAN</label>
                        <div class="ttd-info">
                            <input type="file" name="ttd_pegawai" accept="image/png, image/jpeg, image/jpg" class="form-control-custom" style="flex: 1;">
                            @if($pegawai->ttd_pegawai)
                                @php
                                    $ttd_path = public_path('uploads/ttd/' . $pegawai->ttd_pegawai);
                                @endphp
                                @if(file_exists($ttd_path))
                                    <img src="{{ asset('uploads/ttd/' . $pegawai->ttd_pegawai) }}" class="ttd-preview" alt="TTD">
                                @endif
                                <label class="checkbox-label">
                                    <input type="checkbox" name="hapus_ttd" value="1"> Hapus TTD
                                </label>
                            @endif
                        </div>
                        <small class="helper-text">
                            <i class="fas fa-info-circle"></i> Upload gambar tanda tangan baru (format PNG/JPG). Kosongkan jika tidak ingin mengubah.
                        </small>
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('pegawai.index') }}" class="btn btn-action btn-back">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                        <button type="submit" name="proses" class="btn btn-action btn-update">
