...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .total-row td {
            background-color: #fef9ef; font-weight: 700; border-top: 2px solid #ff8c1a; border-bottom: 2px solid #ff8c1a;
        }
        .total-row .total-label { text-align: right; font-weight: 700; color: #1c3f4f; }
        .total-row .total-amount { text-align: center; font-weight: 800; color: #ff8c1a; background: white; border-radius: 8px; font-size: 0.85rem; }
        .card-table {
            border: none; border-radius: 20px; background: white;
            box-shadow: 0 12px 28px -8px rgba(0, 32, 64, 0.08); overflow: hidden; margin-top: 0.8rem; margin-bottom: 1.5rem;
        }
        ...
        .btn-add {
            ...
            padding: 5px 14px; font-weight: 500; font-size: 0.7rem; transition: all 0.2s;
            text-decoration: none; display: inline-flex; align-items: center; gap: 5px;
        }
        .btn-add:hover { background: linear-gradient(95deg, #ffa233, #ff7a0f); transform: translateY(-1px); color: white; }
...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-3 p-md-4">
                ...
                <div class="form-row-custom">
                    <div>
                        <div class="form-group-custom">
                            ...
                            <input type="text" class="form-control-custom" value="{{ $barang->no_barang }}" readonly>
                        </div>
                        <div class="form-group-custom">
                            <label><i class="fas fa-tag"></i> NAMA BARANG</label>
                            <input type="text" class="form-control-custom" value="{{ $barang->nama_barang }}" readonly>
                        </div>
                        <div class="form-group-custom">
                            <label><i class="fas fa-ruler"></i> UKURAN</label>
                            <input type="text" class="form-control-custom" value="{{ $barang->ukuran }}" readonly>
                        </div>
                    </div>
                    <div>
                        <div class="form-group-custom">
                            <label><i class="fas fa-cubes"></i> STOK BARANG</label>
                            <input type="text" class="form-control-custom" value="{{ number_format($barang->stok_barang, 0, ',', '.') }}" readonly>
                        </div>
                        <div class="form-group-custom">
                            <label><i class="fas fa-money-bill-wave"></i> HARGA BARANG</label>
                            <input type="text" class="form-control-custom" value="Rp {{ number_format($barang->harga_barang, 0, ',', '.') }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="data-table-wrapper">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="7" style="text-align:center; padding:20px;">Belum ada bahan baku untuk barang ini.</td>
                        </tr>
                        @endforelse
                        ...
                        <tr class="total-row">
                            <td colspan="5" class="total-label">
                                <strong><i class="fas fa-calculator" style="color:#ff8c1a;"></i> TOTAL BIAYA BAHAN BAKU (HPP)</strong>
                            </td>
        ...
        <div class="back-button-container">
            <a href="{{ route('barang.index') }}" class="btn btn-action btn-back">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5>Delete Detail BOM</h5>
                <p>Are you sure you want to delete this detail BOM?</p>
