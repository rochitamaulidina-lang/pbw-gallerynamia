...
<head>
    ...
    <title>Tambah Barang - Gallery Namia</title>
    ...
    <style>
        /* CSS SAMA PERSIS DENGAN CREATE BAHAN BAKU */
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h3><i class="fas fa-boxes"></i> Tambah Barang</h3>
            </div>
            <div class="card-body-custom">
                ...
                <form action="{{ route('barang.store') }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="no_barang" class="form-control-custom" placeholder="Masukkan no barang" value="{{ old('no_barang') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-box"></i> NAMA BARANG</label>
                        <input type="text" name="nama_barang" class="form-control-custom" placeholder="Masukkan nama barang" value="{{ old('nama_barang') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-ruler"></i> UKURAN</label>
                        <input type="text" name="ukuran" class="form-control-custom" placeholder="Masukkan ukuran (contoh: S, M, L, Free Size)" value="{{ old('ukuran') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-warehouse"></i> STOK</label>
                        <input type="number" name="stok_barang" class="form-control-custom" placeholder="Masukkan stok" value="{{ old('stok_barang', 0) }}" required min="0">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-money-bill"></i> HARGA</label>
                        <input type="number" name="harga_barang" class="form-control-custom" placeholder="Masukkan harga" value="{{ old('harga_barang', 0) }}" required min="0" step="0.01">
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('barang.index') }}" class="btn btn-action btn-cancel">
