...
<head>
    ...
    <title>Daftar Barang - Gallery Namia</title>
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="card-table">
            <div class="card-header-custom">
                <h5><i class="fas fa-boxes mr-2" style="color:#ff8c1a;"></i> Daftar Barang</h5>
                <a href="{{ route('barang.create') }}" class="btn btn-warning-custom">
            ...
            <div class="table-wrapper">
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>
                                <a href="{{ route('barang.index', ['sort' => 'no_barang', 'order' => ($sortColumn == 'no_barang' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NO BARANG
                            ...
                            <th>
                                <a href="{{ route('barang.index', ['sort' => 'nama_barang', 'order' => ($sortColumn == 'nama_barang' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NAMA BARANG
                                    <span class="sort-icon">
                                        @if($sortColumn == 'nama_barang') {!! $sortOrder == 'DESC' ? '↓' : '↑' !!} @else ↕ @endif
                                    </span>
                                </a>
                            </th>
                            <th>
                                <a href="{{ route('barang.index', ['sort' => 'ukuran', 'order' => ($sortColumn == 'ukuran' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    UKURAN
                                    <span class="sort-icon">
                                        @if($sortColumn == 'ukuran') {!! $sortOrder == 'DESC' ? '↓' : '↑' !!} @else ↕ @endif
                                    </span>
                                </a>
                            </th>
                            <th>
                                <a href="{{ route('barang.index', ['sort' => 'stok_barang', 'order' => ($sortColumn == 'stok_barang' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    STOK
                                    <span class="sort-icon">
                                        @if($sortColumn == 'stok_barang') {!! $sortOrder == 'DESC' ? '↓' : '↑' !!} @else ↕ @endif
                                    </span>
                                </a>
                            </th>
                            <th>
                                <a href="{{ route('barang.index', ['sort' => 'harga_barang', 'order' => ($sortColumn == 'harga_barang' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    HARGA
                                    <span class="sort-icon">
                                        @if($sortColumn == 'harga_barang') {!! $sortOrder == 'DESC' ? '↓' : '↑' !!} @else ↕ @endif
                                    </span>
                                </a>
                            </th>
                            <th>KETERANGAN</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                <a class="btn btn-sm-action btn-edit" href="{{ route('barang.edit', $b->no_barang) }}">
                                    <i class="fa-solid fa-pen-to-square"></i> Ubah
                                </a>
                                <button class="btn btn-sm-action btn-delete" onclick="showDeleteModal('{{ $b->no_barang }}', 'barang')">
            ...
            <div class="pagination">
                <div class="pagination-info">
                    Showing {{ $barang->firstItem() ?? 0 }} to {{ $barang->lastItem() ?? 0 }} of {{ $barang->total() }} entries
                </div>
