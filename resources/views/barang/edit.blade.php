...
<head>
    ...
    <title>Edit Barang - Gallery Namia</title>
    ...
    <style>
        /* CSS SAMA PERSIS DENGAN EDIT BAHAN BAKU */
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h3><i class="fas fa-boxes"></i> Edit Barang</h3>
            </div>
            <div class="card-body-custom">
                ...
                <form action="{{ route('barang.update', $barang->no_barang) }}" method="POST">
                    @csrf @method('PUT')

                    <div class="form-group-custom">
                        <label><i class="fas fa-hashtag"></i> NO BARANG</label>
                        <input type="text" name="no_barang" class="form-control-custom" value="{{ $barang->no_barang }}" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-box"></i> NAMA BARANG</label>
                        <input type="text" name="nama_barang" class="form-control-custom" value="{{ $barang->nama_barang }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-ruler"></i> UKURAN</label>
                        <input type="text" name="ukuran" class="form-control-custom" value="{{ $barang->ukuran }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-warehouse"></i> STOK</label>
                        <input type="number" name="stok_barang" class="form-control-custom" value="{{ $barang->stok_barang }}" required min="0">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-money-bill"></i> HARGA</label>
                        <input type="number" name="harga_barang" class="form-control-custom" value="{{ $barang->harga_barang }}" required min="0" step="0.01">
                    </div>
