...
<head>
    ...
    <title>Edit Bahan Baku - Gallery Namia</title>
    <!-- CSS sama seperti create.blade.php -->
    ...
    <style>
        /* CSS SAMA PERSIS DENGAN CREATE.BLADE.PHP */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-control-custom::placeholder { color: #adb5bd; font-weight: 400; font-size: 0.7rem; }
        .btn-action {
            border-radius: 30px; padding: 6px 20px; font-weight: 600; font-size: 0.7rem; transition: all 0.2s;
            display: inline-flex; align-items: center; gap: 8px; margin: 0 4px; text-decoration: none; border: none;
        }
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h3><i class="fas fa-box-open"></i> Edit Bahan Baku</h3>
            </div>
            <div class="card-body-custom">
                ...
                <form action="{{ route('bahanbaku.update', $bahanBaku->no_bahan) }}" method="POST">
                    @csrf @method('PUT')

                    <div class="form-group-custom">
                        <label><i class="fas fa-hashtag"></i> NO BAHAN</label>
                        <input type="text" name="no_bahan" class="form-control-custom" value="{{ $bahanBaku->no_bahan }}" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-box"></i> NAMA BAHAN</label>
                        <input type="text" name="nama_bahan" class="form-control-custom" value="{{ $bahanBaku->nama_bahan }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-warehouse"></i> STOK</label>
                        <input type="number" name="stok_bahan" class="form-control-custom" value="{{ $bahanBaku->stok_bahan }}" required min="0">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-ruler"></i> SATUAN</label>
                        <input type="text" name="satuan" class="form-control-custom" value="{{ $bahanBaku->satuan }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-exclamation-triangle"></i> STOK KRITIS</label>
                        <input type="number" name="stok_kritis" class="form-control-custom" value="{{ $bahanBaku->stok_kritis }}" required min="0">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-money-bill"></i> HARGA BELI</label>
                        <input type="number" name="harga_beli" class="form-control-custom" value="{{ $bahanBaku->harga_beli }}" required min="0" step="0.01">
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('bahanbaku.index') }}" class="btn btn-action btn-back">
