...
<head>
    ...
    <title>Tambah Bahan Baku - Gallery Namia</title>
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h3><i class="fas fa-box-open"></i> Tambah Bahan Baku</h3>
            </div>
            <div class="card-body-custom">
                ...
                <form action="{{ route('bahanbaku.store') }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="no_bahan" class="form-control-custom" placeholder="Masukkan no bahan" value="{{ old('no_bahan') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-box"></i> NAMA BAHAN</label>
                        <input type="text" name="nama_bahan" class="form-control-custom" placeholder="Masukkan nama bahan" value="{{ old('nama_bahan') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-warehouse"></i> STOK</label>
                        <input type="number" name="stok_bahan" class="form-control-custom" placeholder="Masukkan stok" value="{{ old('stok_bahan', 0) }}" required min="0">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-ruler"></i> SATUAN</label>
                        <input type="text" name="satuan" class="form-control-custom" placeholder="Masukkan satuan (contoh: kg, meter, yard)" value="{{ old('satuan') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-exclamation-triangle"></i> STOK KRITIS</label>
                        <input type="number" name="stok_kritis" class="form-control-custom" placeholder="Masukkan batas stok kritis" value="{{ old('stok_kritis', 0) }}" required min="0">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-money-bill"></i> HARGA BELI</label>
                        <input type="number" name="harga_beli" class="form-control-custom" placeholder="Masukkan harga beli" value="{{ old('harga_beli', 0) }}" required min="0" step="0.01">
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('bahanbaku.index') }}" class="btn btn-action btn-cancel">
