...
<head>
    ...
    <title>Ubah Penjualan - Gallery Namia</title>
    ...
    <style>
        /* ========== CSS SAMA PERSIS DENGAN PEMBELIAN EDIT ========== */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-detail-manage:hover { background: #138496; transform: translateY(-2px); color: white; }
        .info-badge {
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h5><i class="fas fa-edit mr-2" style="color:#ff8c1a;"></i> Ubah Penjualan</h5>
            </div>
            <div class="card-body-custom">
                ...
                <form action="{{ route('penjualan.update', $penjualan->no_jual) }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="date" name="tgl_jual" class="form-control-custom" value="{{ old('tgl_jual', $penjualan->tgl_jual) }}" required>
                    </div>
                    ...
                    <div class="form-group-custom">
                        ...
                        <select class="form-control-custom" name="no_pegawai" required>
                            ...
                            <option value="{{ $p->no_pegawai }}" {{ old('no_pegawai', $penjualan->no_pegawai) == $p->no_pegawai ? 'selected' : '' }}>
                                {{ $p->nama_pegawai }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" class="form-control-custom" value="Rp {{ number_format($penjualan->total_jual, 0, ',', '.') }}" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-wallet"></i> DP</label>
                        <input type="text" class="form-control-custom" value="Rp {{ number_format($penjualan->dp, 0, ',', '.') }}" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-coins"></i> SISA BAYAR</label>
                        <input type="text" class="form-control-custom" value="Rp {{ number_format($penjualan->sisa_bayar, 0, ',', '.') }}" readonly>
                    </div>

                    <div class="info-badge">
                        <i class="fas fa-info-circle"></i> Untuk mengubah detail penjualan, silakan ke halaman detail penjualan.
                    </div>
