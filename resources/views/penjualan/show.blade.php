...
<head>
    ...
    <title>Detail Penjualan - Gallery Namia</title>
    ...
    <style>
        /* ========== CSS SAMA PERSIS DENGAN PEMBELIAN SHOW ========== */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #sidebar {
            ...
            box-shadow: 8px 0 25px rgba(0, 0, 0, 0.08); z-index: 1000; border-radius: 0 20px 20px 0; overflow-y: auto;
        }
        ...
        .navbar-custom {
            ...
            box-shadow: 0 5px 18px rgba(0, 0, 0, 0.03); margin-bottom: 1.5rem;
        }
        .btn-toggle {
            background: #1f5e7e; border: none; color: white; border-radius: 30px;
            padding: 5px 14px; font-weight: 500; font-size: 0.75rem; cursor: pointer;
        }
        .btn-toggle:hover { background: #0f4a64; }
        .page-header { margin-bottom: 1.5rem; }
        .page-header h2 {
            font-weight: 700; font-size: 1.5rem; color: #1e2f3a;
            position: relative; display: inline-block;
        }
        .page-header h2:after {
            content: ''; position: absolute; bottom: -8px; left: 0;
            width: 45px; height: 3px; background: linear-gradient(90deg, #ff8c1a, #ffb347); border-radius: 3px;
        }
        .form-card {
        ...
        .form-card .card-header-custom h3 {
            font-weight: 700; color: #1c3f4f; margin: 0; font-size: 1.2rem;
            display: flex; align-items: center; gap: 10px;
        }
        .form-card .card-header-custom h3 i { color: #ff8c1a; font-size: 1.4rem; }
        .form-card .card-body-custom { padding: 1.5rem; }
        .form-group-custom { margin-bottom: 1rem; }
        .form-group-custom label {
            font-weight: 600; color: #2c5a6e; margin-bottom: 0.3rem;
            font-size: 0.75rem; letter-spacing: 0.3px; display: block;
        }
        .form-group-custom label i { margin-right: 6px; color: #ff8c1a; width: 20px; }
        .form-control-custom {
            width: 100%; padding: 8px 14px; font-size: 0.8rem; font-weight: 500;
            border: 2px solid #e2e8f0; border-radius: 14px; transition: all 0.2s;
            background: #fefefe; font-family: 'Poppins', sans-serif;
        }
        .form-control-custom:focus {
            outline: none; border-color: #ff8c1a; box-shadow: 0 0 0 3px rgba(255, 140, 26, 0.1);
        }
        .form-control-custom[readonly] {
            background: #f5f7fb; color: #6c7e8f; border-color: #e9ecef;
        }
        .form-row-custom {
        ...
        .card-table {
            border: none; border-radius: 20px; background: white;
            box-shadow: 0 10px 22px -8px rgba(0, 32, 64, 0.08);
            overflow: hidden; margin-top: 0.8rem; margin-bottom: 1.5rem;
        }
        .card-table .card-header-custom {
            background: transparent; padding: 0.8rem 1.2rem;
            border-bottom: 1px solid #eef2f7;
        ...
        .data-table-wrapper { padding: 0 0.8rem 0.8rem 0.8rem; overflow-x: auto; }
        .data-table { width: 100%; border-collapse: collapse; }
        .data-table thead th {
            background: #f8fafd; color: #1e4a62; font-weight: 600; font-size: 0.65rem;
            text-transform: uppercase; padding: 10px 8px; border-bottom: 2px solid #e2e8f0;
            text-align: center !important; border-right: 1px solid #e9ecef;
        }
        .data-table thead th:last-child { border-right: none; }
        .data-table tbody td {
            padding: 8px 8px; vertical-align: middle; color: #2c3e4e;
            border-bottom: 1px solid #ecf3f8; text-align: center;
            border-right: 1px solid #f0f2f5; font-size: 0.7rem;
        }
        ...
        .btn-sm-action {
            border-radius: 30px; padding: 3px 8px; font-size: 0.6rem; font-weight: 500;
        ...
        .btn-back {
            background: #dc3545; border: none; color: white; border-radius: 30px;
            padding: 6px 20px; font-weight: 600; font-size: 0.75rem;
            transition: all 0.2s; text-decoration: none;
            display: inline-flex; align-items: center; gap: 6px;
        }
        .btn-back:hover { background: #c82333; transform: translateY(-1px); color: white; text-decoration: none; }
        .btn-add {
            background: linear-gradient(95deg, #ffb347, #ff8c1a); color: white; border-radius: 30px;
            padding: 5px 14px; font-weight: 500; font-size: 0.7rem;
            transition: all 0.2s; text-decoration: none;
        ...
        .btn-print-show {
            background: #17a2b8; color: white; border-radius: 30px;
            padding: 5px 14px; font-weight: 500; font-size: 0.7rem;
            transition: all 0.2s; text-decoration: none;
            display: inline-flex; align-items: center; gap: 5px; border: none;
        }
        .btn-print-show:hover { background: #138496; transform: translateY(-1px); color: white; }
        .info-box {
            padding: 10px 16px; background: #f8fafd; border-radius: 12px;
        ...
        .info-box .info-item strong { color: #1c3f4f; font-weight: 600; }
        .info-box .info-item .label { color: #6c7e8f; font-weight: 400; }
        .navbar-nav .nav-link {
            font-weight: 500; color: #3a5b6e; margin: 0 4px;
            border-radius: 30px; padding: 4px 12px; font-size: 0.7rem;
        }
        ...
        .back-button-container { margin-top: 0.8rem; margin-bottom: 0.8rem; text-align: left; }
        .modal-custom .modal-content {
            border-radius: 20px; border: none; box-shadow: 0 20px 35px -10px rgba(0, 0, 0, 0.2);
            overflow: hidden;
        }
        ...
        .modal-custom .warning-text { color: #dc3545; font-size: 0.75rem; font-weight: 500; margin-top: 0.3rem; }
        .btn-cancel-modal { background: #e9ecef; border: none; border-radius: 30px; padding: 6px 20px; font-weight: 600; font-size: 0.75rem; color: #495057; transition: all 0.2s; }
        ...
        @media (max-width: 768px) {
            ...
            .form-row-custom { grid-template-columns: 1fr; gap: 0.8rem; }
            .btn-sm-action { padding: 2px 6px; font-size: 0.55rem; }
            .back-button-container { text-align: center; }
            .form-card .card-body-custom { padding: 1rem; }
            .info-box { flex-direction: column; gap: 6px; }
        }
    </style>
</head>
<body>
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h3><i class="fas fa-file-alt"></i> Informasi Penjualan</h3>
            </div>
            <div class="card-body-custom">
                <div class="info-box">
                    <div class="info-item">
                        <span class="label"><i class="fas fa-hashtag"></i> No Jual:</span>
                        <strong>{{ $penjualan->no_jual }}</strong>
                    </div>
                    <div class="info-item">
                        <span class="label"><i class="fas fa-calendar-alt"></i> Tanggal:</span>
                        <strong>{{ date('d/m/Y', strtotime($penjualan->tgl_jual)) }}</strong>
                    </div>
                    <div class="info-item">
                        <span class="label"><i class="fas fa-user"></i> Pelanggan:</span>
                        <strong>{{ $penjualan->pelanggan->nama_pelanggan ?? '-' }}</strong>
                    </div>
                    <div class="info-item">
                        <span class="label"><i class="fas fa-user-tie"></i> Pegawai:</span>
                        <strong>{{ $penjualan->pegawai->nama_pegawai ?? '-' }}</strong>
                    </div>
                    <div class="info-item">
                        <span class="label"><i class="fas fa-money-bill-wave"></i> Total:</span>
                        <strong style="color:#ff8c1a;">Rp {{ number_format($penjualan->total_jual, 0, ',', '.') }}</strong>
                    </div>
                    <div class="info-item">
                        <span class="label"><i class="fas fa-wallet"></i> DP:</span>
                        <strong style="color:#ff8c1a;">Rp <span id="dp_display">{{ number_format($penjualan->dp, 0, ',', '.') }}</span></strong>
                    </div>
                    <div class="info-item">
                        <span class="label"><i class="fas fa-coins"></i> Sisa Bayar:</span>
                        <strong style="color:#ff8c1a;">Rp <span id="sisa_display">{{ number_format($penjualan->sisa_bayar, 0, ',', '.') }}</span></strong>
                    </div>
                </div>
            </div>
        </div>

        {{-- Tabel Detail Penjualan + CRUD --}}
        <div class="card-table">
            <div class="card-header-custom">
                <h5><i class="fas fa-boxes mr-2" style="color:#ff8c1a;"></i> Daftar Detail Penjualan</h5>
                <div style="display:flex; gap:12px; align-items:center;">
                    <div style="border:1px solid #ffb347; background-color:#fff8f0; padding:4px 12px; border-radius:30px; display:inline-flex; align-items:center; gap:8px;">
                        <input type="checkbox" id="dpCheckbox" {{ $penjualan->dp > 0 ? 'checked' : '' }}>
                        <label for="dpCheckbox" style="margin:0; font-size:0.7rem; font-weight:500; color:#c46a00; cursor:pointer;">DP 30%</label>
                    </div>
                    <a href="{{ route('penjualan.cetak', $penjualan->no_jual) }}" target="_blank" class="btn-print-show">
                        <i class="fas fa-print"></i> Cetak
                    </a>
                    <a href="{{ route('detailpenjualan.create', $penjualan->no_jual) }}" class="btn-add">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp {{ number_format($detail->barang->harga_barang ?? 0, 0, ',', '.') }}</td>
                            <td>Rp {{ number_format($detail->subtotal_jual, 0, ',', '.') }}</td>
                            <td>
                                <a class="btn btn-sm-action btn-edit" href="{{ route('detailpenjualan.edit', [$penjualan->no_jual, $detail->no_barang]) }}">
                                    <i class="fa-solid fa-pen-to-square"></i> Ubah
                                </a>
                                <button class="btn btn-sm-action btn-delete" onclick="showDeleteModal('{{ $penjualan->no_jual }}', '{{ $detail->no_barang }}')">
                        ...
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">
                                <i class="fas fa-info-circle"></i> Belum ada detail penjualan.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
                        ...
                        <tr class="total-row">
                            <td colspan="5" class="total-label">
                                <strong>
                                    ...
                                    <span style="margin-left: 5px;">TOTAL PENJUALAN</span>
                                </strong>
                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5>Hapus Detail Penjualan</h5>
                <p>Yakin mau hapus detail penjualan ini?</p>
...
<script>
    $(document).ready(function() {
        ...
        // ========== DP 30% ==========
        $('#dpCheckbox').on('change', function() {
            var isChecked = $(this).prop('checked');
            var total = {{ $penjualan->total_jual }};
            var dpValue = 0;
            var sisa = 0;
            
            if (isChecked) {
                dpValue = Math.round(total * 0.3);
                sisa = total - dpValue;
            }
            
            // Update tampilan
            $('#dp_display').text(new Intl.NumberFormat('id-ID').format(dpValue));
            $('#sisa_display').text(new Intl.NumberFormat('id-ID').format(sisa));
            
            // Kirim ke server
            $.ajax({
                url: "{{ route('penjualan.updateDp', $penjualan->no_jual) }}",
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    dp: dpValue,
                ...
                success: function(res) {
                    if (res.trim() !== 'success') {
                        alert('Gagal mengupdate DP. Silakan coba lagi.');
                        location.reload();
                    }
                },
                error: function() {
    ...
    function showDeleteModal(no_jual, no_barang) {
        var form = document.getElementById('deleteForm');
        form.action = "{{ route('detailpenjualan.destroy', ['no_jual' => '__NO_JUAL__', 'no_barang' => '__NO_BARANG__']) }}"
            .replace('__NO_JUAL__', no_jual)
            .replace('__NO_BARANG__', no_barang);
