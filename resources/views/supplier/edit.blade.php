...
<head>
    ...
    <title>Ubah Supplier - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN supplier-ubah.php ========== */
        * {
            margin: 0;
            padding: 0;
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            ...
            <div class="card-body-custom">
                ...
                <form action="{{ route('supplier.update', $supplier->no_supplier) }}" method="post">
                    @csrf
                    @method('PUT')

                    <div class="form-group-custom">
                        <label><i class="fas fa-id-card"></i> NO SUPPLIER</label>
                        <input type="text" class="form-control-custom" name="no_supplier" value="{{ $supplier->no_supplier }}" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-building"></i> NAMA SUPPLIER</label>
                        <input type="text" class="form-control-custom" name="nama_supplier" value="{{ $supplier->nama_supplier }}" placeholder="Masukkan Nama Supplier" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-map-marker-alt"></i> ALAMAT</label>
                        <input type="text" class="form-control-custom" name="alamat_supplier" value="{{ $supplier->alamat_supplier }}" placeholder="Masukkan Alamat Supplier" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-phone-alt"></i> TELEPON</label>
                        <input type="tel" class="form-control-custom" name="tlp_supplier" value="{{ $supplier->tlp_supplier }}" placeholder="Masukkan Nomor Telepon Supplier" required>
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('supplier.index') }}" class="btn btn-action btn-back">
