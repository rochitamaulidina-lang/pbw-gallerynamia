...
<head>
    ...
    <title>Tambah Supplier - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN supplier-tambah.php ========== */
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body-custom">
                ...
                <form action="{{ route('supplier.store') }}" method="post">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="no_supplier" class="form-control-custom" placeholder="Masukkan no supplier" value="{{ old('no_supplier') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-building"></i> NAMA SUPPLIER</label>
                        <input type="text" name="nama_supplier" class="form-control-custom" placeholder="Masukkan nama supplier" value="{{ old('nama_supplier') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-map-marker-alt"></i> ALAMAT</label>
                        <input type="text" name="alamat_supplier" class="form-control-custom" placeholder="Masukkan alamat lengkap supplier" value="{{ old('alamat_supplier') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-phone-alt"></i> TELEPON</label>
                        <input type="tel" name="tlp_supplier" class="form-control-custom" placeholder="Masukkan nomor telepon supplier" value="{{ old('tlp_supplier') }}" required>
                    </div>

                    <div class="info-badge">
                        <i class="fas fa-info-circle"></i> Pastikan ID supplier belum terdaftar sebelumnya.
                    </div>

                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('supplier.index') }}" class="btn btn-action btn-cancel">
