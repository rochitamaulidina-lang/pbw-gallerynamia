...
<head>
    ...
    <title>Ubah Pelanggan - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN pelanggan-ubah.php ========== */
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body-custom">
                ...
                <form action="{{ route('pelanggan.update', $pelanggan->no_pelanggan) }}" method="post">
                    ...
                    <div class="form-group-custom">
                        <label><i class="fas fa-id-card"></i> NO PELANGGAN</label>
                        <input type="text" name="no_pelanggan" value="{{ $pelanggan->no_pelanggan }}" class="form-control-custom" readonly>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-users"></i> NAMA PELANGGAN</label>
                        <input type="text" name="nama_pelanggan" value="{{ $pelanggan->nama_pelanggan }}" class="form-control-custom" placeholder="Masukkan nama pelanggan" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-phone-alt"></i> TELEPON</label>
                        <input type="tel" name="tlp_pelanggan" value="{{ $pelanggan->tlp_pelanggan }}" class="form-control-custom" placeholder="Masukkan nomor telepon pelanggan" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-envelope"></i> EMAIL</label>
                        <input type="email" name="email_pelanggan" value="{{ $pelanggan->email_pelanggan }}" class="form-control-custom" placeholder="Masukkan email pelanggan (opsional)">
                        <small class="text-muted" style="font-size: 0.6rem; display: block; margin-top: 0.25rem;">
                            <i class="fas fa-info-circle"></i> Email tidak wajib diisi
                        </small>
                    </div>
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('pelanggan.index') }}" class="btn btn-action btn-back">
