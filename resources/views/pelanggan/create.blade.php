...
<head>
    ...
    <title>Tambah Pelanggan - Gallery Namia</title>
    ...
    <style>
        /* ========== SEMUA CSS SAMA PERSIS DENGAN pelanggan-tambah.php ========== */
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body-custom">
                ...
                <form action="{{ route('pelanggan.store') }}" method="post">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="no_pelanggan" class="form-control-custom" placeholder="Masukkan no pelanggan" value="{{ old('no_pelanggan') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-users"></i> NAMA PELANGGAN</label>
                        <input type="text" name="nama_pelanggan" class="form-control-custom" placeholder="Masukkan nama pelanggan" value="{{ old('nama_pelanggan') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-phone-alt"></i> TELEPON</label>
                        <input type="tel" name="tlp_pelanggan" class="form-control-custom" placeholder="Masukkan nomor telepon pelanggan" value="{{ old('tlp_pelanggan') }}" required>
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-envelope"></i> EMAIL</label>
                        <input type="email" name="email_pelanggan" class="form-control-custom" placeholder="Masukkan email pelanggan (opsional)" value="{{ old('email_pelanggan') }}">
                    ...
                    <div class="mt-3" style="display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="{{ route('pelanggan.index') }}" class="btn btn-action btn-cancel">
