...
<head>
    ...
    <title>Daftar Pelanggan - Gallery Namia</title>
    ...
    <nav id="sidebar">
        <div class="p-3 pt-3">
            ...
            <ul class="list-unstyled components mb-4">
                ...
                <li class="active"><a href="{{ route('pelanggan.index') }}"><i class="fas fa-user-group"></i> Pelanggan</a></li>
    ...
    <div id="content" class="p-3 p-md-4">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="{{ route('pelanggan.index') }}">Pelanggan</a></li>
        ...
        <div class="card-table">
            <div class="card-header-custom">
                <h5><i class="fas fa-user-group mr-2" style="color:#ff8c1a;"></i> Daftar Pelanggan</h5>
                <a href="{{ route('pelanggan.create') }}" class="btn btn-warning-custom">
                    <i class="fas fa-plus-circle mr-1"></i> Tambah Pelanggan
                </a>
            </div>
            ...
            <div class="table-wrapper">
                <table class="data-table" id="data-table">
                    <thead>
                        <tr>
                            <th>
                                <a href="{{ route('pelanggan.index', ['sort' => 'no_pelanggan', 'order' => ($sortColumn == 'no_pelanggan' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NO PELANGGAN
                                    <span class="sort-icon">
                                        @if($sortColumn == 'no_pelanggan')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                            ...
                            <th>
                                <a href="{{ route('pelanggan.index', ['sort' => 'nama_pelanggan', 'order' => ($sortColumn == 'nama_pelanggan' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NAMA PELANGGAN
                                    <span class="sort-icon">
                            ...
                            <th>
                                <a href="{{ route('pelanggan.index', ['sort' => 'tlp_pelanggan', 'order' => ($sortColumn == 'tlp_pelanggan' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    NO TELEPON
                                    <span class="sort-icon">
                                        @if($sortColumn == 'tlp_pelanggan')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                            ...
                            <th>
                                <a href="{{ route('pelanggan.index', ['sort' => 'email_pelanggan', 'order' => ($sortColumn == 'email_pelanggan' && $sortOrder == 'DESC') ? 'ASC' : 'DESC']) }}">
                                    EMAIL
                                    <span class="sort-icon">
                                        @if($sortColumn == 'email_pelanggan')
                                            {!! $sortOrder == 'DESC' ? '↓' : '↑' !!}
                                        @else
                                            ↕
                                        @endif
                    ...
                    <tbody id="table-body">
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                <a class="btn btn-sm-action btn-edit" href="{{ route('pelanggan.edit', $p->no_pelanggan) }}">
                                    <i class="fa-solid fa-pen-to-square"></i> Ubah
                                </a>
                                <button class="btn btn-sm-action btn-delete" onclick="showDeleteModal('{{ $p->no_pelanggan }}')">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" style="text-align:center; padding:20px;">Tidak ada data pelanggan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="pagination">
                <div class="pagination-info">
                    Showing {{ $pelanggan->firstItem() ?? 0 }} to {{ $pelanggan->lastItem() ?? 0 }} of {{ $pelanggan->total() }} entries
                </div>
                <div class="pagination-buttons">
                    @if ($pelanggan->onFirstPage())
                        <span class="page-link disabled">Previous</span>
                    @else
                        <a class="page-link" href="{{ $pelanggan->previousPageUrl() }}">Previous</a>
                    @endif
                    ...
                    @if ($pelanggan->hasMorePages())
                        <a class="page-link" href="{{ $pelanggan->nextPageUrl() }}">Next</a>
                    @else
