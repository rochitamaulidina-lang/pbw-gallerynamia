...
<head>
    ...
    <title>Tambah Pembelian - Gallery Namia</title>
    ...
    <div id="content" class="p-3 p-md-4">
        ...
        <div class="form-card">
            <div class="card-header-custom">
                <h5><i class="fas fa-plus-circle mr-2" style="color:#ff8c1a;"></i> Tambah Pembelian</h5>
            </div>
            <div class="card-body-custom">
                <form action="{{ route('pembelian.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="no_faktur" class="form-control-custom" placeholder="Masukkan Nomor Faktur" value="{{ old('no_faktur') }}">
                    </div>

                    <div class="form-group-custom">
                        <label><i class="fas fa-calendar-alt"></i> TANGGAL BELI</label>
                        <input type="date" name="tgl_beli" class="form-control-custom" value="{{ old('tgl_beli', date('Y-m-d')) }}" required>
                    </div>
                    ...
                    <div class="form-group-custom">
                        ...
                        <select class="form-control-custom" name="no_supplier" required>
                            ...
                            <option value="{{ $s->no_supplier }}" {{ old('no_supplier') == $s->no_supplier ? 'selected' : '' }}>
                                {{ $s->nama_supplier }}
                            </option>
                            @endforeach
                        </select>
